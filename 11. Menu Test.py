...
def main(animCounter, unitTypeList, attackTypeList, buildingTypeList, waveList):
    ...
    pygame.display.set_caption("Gameplay Test 1")
    background_terran = pygame.image.load(os.path.join('sprites', 'TerranBG 1800x600.png')).convert()
    background_protoss = pygame.image.load(os.path.join('sprites', 'TerranBG 1800x600.png')).convert()
    background_zerg = pygame.image.load(os.path.join('sprites', 'TerranBG 1800x600.png')).convert()
    imageSize = [1800,600]
    ...
    while running:
        ...
        if gameOver == 1: #game end event
            if wave == 10:
                ...
                endPos = currency.get_rect(center=(325, 275))
...
if __name__ == "__main__":
    ...
    protossWaves = []
    p1 = ["Zealot", "Zealot", "Stalker"]
    protossWaves.append(p1)
    p2 = ["Immortal", "Stalker", "Stalker"]
    protossWaves.append(p2)
    p3 = ["Immortal", "Stalker", "Stalker"]
    protossWaves.append(p3)
    p4 = ["Immortal", "Stalker", "Stalker"]
    protossWaves.append(p4)
    p5 = ["Immortal", "Stalker", "Stalker"]
    protossWaves.append(p5)
    p6 = ["Immortal", "Stalker", "Stalker"]
    protossWaves.append(p6)
    p7 = ["Immortal", "Stalker", "Stalker"]
    protossWaves.append(p7)
    p8 = ["Immortal", "Stalker", "Stalker"]
    protossWaves.append(p8)
    p9 = ["Immortal", "Stalker", "Stalker"]
    ...
    t2 = ["Hellion", "Hellion", "Marine", "Marine", "Hellion", "Marine"]
    terranWaves.append(t2)
    t3 = ["Hellion", "Marauder", "Siege Tank", "Marine", "Hellion", "Marauder"]
    terranWaves.append(t3)
    t4 = ["Marine", "Marine", "Marauder", "Marine", "Marine", "Marauder", "Marine", "Marine", "Marauder", "Marine", "Marine", "Marauder"]
    terranWaves.append(t4)
    t5 = ["Hellion", "Hellion", "Siege Tank", "Viking", "Banshee", "Banshee"]
    terranWaves.append(t5)
    t6 = ["Hellion", "Hellion", "Siege Tank", "Viking", "Banshee", "Banshee"]
    terranWaves.append(t6)
    t7 = ["Hellion", "Hellion", "Siege Tank", "Viking", "Banshee", "Banshee"]
    terranWaves.append(t7)
    t8 = ["Hellion", "Hellion", "Siege Tank", "Viking", "Banshee", "Banshee"]
    terranWaves.append(t8)
    t9 = ["Hellion", "Hellion", "Siege Tank", "Viking", "Banshee", "Banshee"]
    terranWaves.append(t9)
    t10 = ["Hellion", "Hellion", "Siege Tank", "Viking", "Banshee", "Banshee"]
    terranWaves.append(t10)

    zergWaves = []
    z1 = ["Zergling", "Zergling", "Baneling", "Zergling", "Zergling", "Baneling"]
    zergWaves.append(z1)
    z2 = ["Zergling", "Zergling", "Baneling", "Zergling", "Zergling", "Baneling"]
    zergWaves.append(z2)
    z3 = ["Zergling", "Zergling", "Baneling", "Zergling", "Zergling", "Baneling"]
    zergWaves.append(z3)
    z4 = ["Zergling", "Zergling", "Baneling", "Zergling", "Zergling", "Baneling"]
    zergWaves.append(z4)
    z5 = ["Zergling", "Zergling", "Baneling", "Zergling", "Zergling", "Baneling"]
    zergWaves.append(z5)
    z6 = ["Zergling", "Zergling", "Baneling", "Zergling", "Zergling", "Baneling"]
    zergWaves.append(z6)
    z7 = ["Zergling", "Zergling", "Baneling", "Zergling", "Zergling", "Baneling"]
    zergWaves.append(z7)
    z8 = ["Zergling", "Zergling", "Baneling", "Zergling", "Zergling", "Baneling"]
    zergWaves.append(z8)
    z9 = ["Zergling", "Zergling", "Baneling", "Zergling", "Zergling", "Baneling"]
    zergWaves.append(z9)
    z10 = ["Zergling", "Zergling", "Baneling", "Zergling", "Zergling", "Baneling"]
